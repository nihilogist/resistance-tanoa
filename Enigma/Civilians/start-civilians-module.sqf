call compile preprocessFileLineNumbers "Enigma\Civilians\Common\Common.sqf";
call compile preprocessFileLineNumbers "Enigma\Civilians\Common\Debug.sqf";
...
if (isServer) then {
	call compile preprocessFileLineNumbers "Enigma\Civilians\Server\ServerFunctions.sqf";
	call compile preprocessFileLineNumbers "Enigma\Civilians\ConfigAndStart.sqf";
};
